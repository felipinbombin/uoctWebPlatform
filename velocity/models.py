...
class Tramos15MinUOCTHistorico74(models.Model):
    eje_id = models.CharField(max_length=200, blank=True, null=True)
    ...
    coeficiente_referencia = models.FloatField(blank=True, null=True)
    vel_referencia = models.FloatField(blank=True, null=True)
    id_en_eje = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'tramos_15min_historico_uoct_red74'
        unique_together = (('fecha', 'periodo15', 'id'),)
